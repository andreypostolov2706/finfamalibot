...
async def process_salary(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        try:
            ...
            # Вычисление 10% для копилки, 90% в семейный бюджет
            ...
            # Пополнение общего семейного бюджета (90%)
            ...
            family_budget.balance += family_amount
            ...
            response += f"Баланс: {family_budget.balance:,.2f} ₽ (+{family_amount:,.2f} ₽)\n\n"
